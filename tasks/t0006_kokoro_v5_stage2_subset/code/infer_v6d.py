...
CONFIG = BASE / "Configs/config_david_v6d_stage2.yml"
CKPT   = BASE / "logs/kokoro-david-v6d/epoch_2nd_00006.pth"
AUDIO  = Path("/mnt/kikiri-tts/data/v4/train/wavs")
OUT    = Path("/mnt/kikiri-tts/infer_v6d"); OUT.mkdir(exist_ok=True)
