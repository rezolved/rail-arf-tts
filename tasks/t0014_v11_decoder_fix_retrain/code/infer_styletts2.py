"""Instrumented StyleTTS2-native inference harness, copied forward for t0014 Milestone C
(REQ-6/REQ-7's mandatory audible-speech gate).

Adapted (paths only -- no logic changes) from
