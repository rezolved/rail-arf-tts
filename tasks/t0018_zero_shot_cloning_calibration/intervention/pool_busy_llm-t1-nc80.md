...
Task `t0018_zero_shot_cloning_calibration` could not acquire a VM from `project/azure_vm.json`.

## Attempts

* **LLM-T1-NC80** (az_show): VM LLM-T1-NC80 is stopping; will not race
